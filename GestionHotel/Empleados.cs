...
namespace GestionHotel
{
    public partial class Empleados : Form
    {
        ...
        private void EstadoControlesInicioApp()
        {
            ...
            cuentaBancariaTextBox.Enabled = false;
            direccion_TextBox.Enabled = false;
            tiempoEnLaEmpresaComboBox.Enabled = false;
        ...
        private void toolStripButtonGuardar_Click(object sender, EventArgs e)
        {
            ...
            this.empleadoTableAdapter.Update(this.hotelDataSet); //Guarda en la base de datos
        ...
        private bool ComprobarDatosIntroducidos()
        {
            ...
            //Cuenta Bancaria
            if (cuentaBancariaTextBox.Text.Length == 0)
            {
                errorProvider1.SetError(cuentaBancariaTextBox, " Cuenta Bancaria obligatoria");
                cuentaBancariaTextBox.Clear();
                return false;
            }

            else if ((cuentaBancariaTextBox.Text.Length != 28) && (cuentaBancariaTextBox.Text.Length != 0)) //24 DÍGITOS Y 4 ESPACIOS  Ejemplo:(ES12 1234 1234 12 0123456789)
            {
                errorProvider1.SetError(cuentaBancariaTextBox, "Debe seguir este formato (ES12 1234 1234 12 0123456789)");
                cuentaBancariaTextBox.Clear();
                return false;
            }
        ...
        private void cuentaBancariaTextBox_Validating(object sender, CancelEventArgs e)
        {
            if ((cuentaBancariaTextBox.Text.Length != 28) && (cuentaBancariaTextBox.Text.Length != 0)) //24 DÍGITOS Y 4 ESPACIOS  Ejemplo:(ES12 1234 1234 12 0123456789)
            {
                errorProvider1.SetError(cuentaBancariaTextBox, "Debe seguir este formato (ES12 1234 1234 12 0123456789)");
                cuentaBancariaTextBox.Clear();
        ...
        private void buttonAyudaEmpleados_Click(object sender, EventArgs e)
        {
        ...
        private void toolStripButtonImprimir_Click(object sender, EventArgs e)
        {
            ...
            string id = idEmpleadoLabel2.Text;
            ...
            string cuentaBancaria = cuentaBancariaTextBox.Text;
            string direccion = direccion_TextBox.Text;
            string tiempoEmpresa = tiempoEnLaEmpresaComboBox.Text;
            ...
            if (printDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                printDocument1.PrintPage += delegate (object sender1, PrintPageEventArgs e1)
                {
                    ...
                    e1.Graphics.DrawString("DNI: " + dni, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 125, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));
                    e1.Graphics.DrawString("Nombre: " + nombre, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 150, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));
                    e1.Graphics.DrawString("Apellidos: " + apellidos, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 175, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));
                    ...
                    e1.Graphics.DrawString("Sexo: " + sexo, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 225, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));
                    e1.Graphics.DrawString("Teléfono: " + telefono, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 250, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));

                    e1.Graphics.DrawString("Cuenta bancaria: " + cuentaBancaria, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 275, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));
                    e1.Graphics.DrawString("Dirección: " + direccion, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 300, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));
                    e1.Graphics.DrawString("Tiempo en la empresa: " + tiempoEmpresa, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(50, 325, printDocument1.DefaultPageSettings.PrintableArea.Width, printDocument1.DefaultPageSettings.PrintableArea.Height));
